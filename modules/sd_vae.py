...
def refresh_vae_list():
    ...
    paths = [
        ...
        os.path.join(sd_models.model_path, '**/*.vae.pth'),
        os.path.join(sd_models.model_path, '**/*.vae.bin'),
        ...
        os.path.join(vae_path, '**/*.pth'),
        os.path.join(vae_path, '**/*.bin'),
    ...
    if shared.cmd_opts.ckpt_dir is not None and os.path.isdir(shared.cmd_opts.ckpt_dir):
        paths += [
            ...
            os.path.join(shared.cmd_opts.ckpt_dir, '**/*.vae.pth'),
            os.path.join(shared.cmd_opts.ckpt_dir, '**/*.vae.bin'),
    ...
    if shared.cmd_opts.vae_dir is not None and os.path.isdir(shared.cmd_opts.vae_dir):
        paths += [
            ...
            os.path.join(shared.cmd_opts.vae_dir, '**/*.pth'),
            os.path.join(shared.cmd_opts.vae_dir, '**/*.bin'),

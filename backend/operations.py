...
def get_weight_and_bias(layer, weight_args=None, bias_args=None, weight_fn=None, bias_fn=None):
    ...
    if layer.weight is not None:
        ...
        if weight_patches is not None:
            weight = backend.patcher.lora.merge_lora_to_weight(patches=weight_patches, weight=weight, key="online weight lora", computation_dtype=weight.dtype)
    ...
    if layer.bias is not None:
        ...
        if bias_patches is not None:
            bias = backend.patcher.lora.merge_lora_to_weight(patches=bias_patches, weight=bias, key="online bias lora", computation_dtype=bias.dtype)
    return weight, bias

...
class Infotext(object):
    ...
    def register_unit(self, unit_index: int, uigroup) -> None:
        ...
        self.infotext_fields.append((uigroup.enabled, f"{unit_prefix} enable"))
        self.paste_field_names.append(f"{unit_prefix} enable")
        self.infotext_fields.append((uigroup.accordion, f"{unit_prefix} accordion"))
        self.paste_field_names.append(f"{unit_prefix} accordion")
